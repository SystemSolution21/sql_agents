"""PostgreSQL SQL agent application.

This is a standalone copy of the sqlite-based agent, adapted to use a Postgres
connection string and placed in a separate directory so the original codebase
remains unchanged.
"""
